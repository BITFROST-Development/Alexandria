...
//                var notebooksToDisplay:[Notebook]! = []
//                if currentVault == nil{
...
//                cell.itemTitle.text = displayingBooks[indexPath.row].name!
//                cell.cellKind = "Book"
...
//                } else if let notebook = displayingVaultItems[indexPath.row] as? Notebook{
...
//                cell.itemTitle.text = filteredBooks[indexPath.row].name!
//                cell.cellKind = "Book"
//                cell.shadowView.alpha = 1
//                cell.shadowWidth.constant = 152
//                cell.shadowHeight.constant = 182.9
...
//                    cell.shadowView.alpha = 0
//                    cell.itemTitle.text = vault.name!
//                } else if let notebook = filteredVaultItems[indexPath.row] as? Notebook{
//                    cell.iconView.image = UIImage(named: notebook.coverStyle!)
//                    cell.cellKind = "Notebook"
//                    cell.shadowView.alpha = 1
//                    cell.shadowWidth.constant = 147
...
//                    if book.name?.localizedCaseInsensitiveContains(searchText) ?? false{
