...
//            newController.selectedCoverName = newSelection
//            newController.tableView.beginUpdates()
//            (newController.tableView.cellForRow(at: IndexPath(row: 0, section: 0)) as! NewNotebookThumbnail).fileThumbnail.image = newImage
//            newController.tableView.reloadRows(at: [IndexPath(row: 2, section: 0)], with: .automatic)
