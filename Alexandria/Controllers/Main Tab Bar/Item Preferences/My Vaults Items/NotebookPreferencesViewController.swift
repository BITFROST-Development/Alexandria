...
//import RealmSwift
//
//class NotebookPreferencesViewController: UIViewController, ItemChangerDelegate {
//    
...
//    var parentVaultMap: VaultMap!{
//        get{
//            let mapList: List<VaultMap>!
//            if parentVault.cloudVar.value ?? false {
//                mapList = alexandria.cloudVaultMaps
//            } else {
//                mapList = alexandria.localVaultMaps
//            }
//            
//            return mapList[Int(parentVault.indexInArray.value!)]
//            
//        }
//    }
...
//        tableView.register(UINib(nibName: "NotebookEditDone", bundle: nil), forCellReuseIdentifier: NotebookEditDone.identifier)
//        NotebookEditDone.controller = self
//    }
//    
...
//
//
//extension NotebookPreferencesViewController: UITableViewDelegate{
...
//}
//
//extension NotebookPreferencesViewController: UITableViewDataSource{
...
//            return cell
//        } else {
//            let cell = tableView.dequeueReusableCell(withIdentifier: NotebookEditDone.identifier) as! NotebookEditDone
//            
//            return cell
//        }
//    }
