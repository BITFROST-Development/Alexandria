...
@IBDesignable
class EditorSetNavigationBarLarge: UIView{
...
extension EditorSetNavigationBarLarge: UICollectionViewDelegate{
	
}

extension EditorSetNavigationBarLarge: UICollectionViewDataSource{
