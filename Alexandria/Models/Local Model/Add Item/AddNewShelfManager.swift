...
////                                realm.objects(CloudUser.self)[0].alexandria!.shelves.append(newShelf)
...
////                                realm.objects(CloudUser.self)[0].alexandria!.localShelves.append(newShelf)
////                            }
////                        } else {
////                            newShelf.cloudVar.value = false
////                            realm.objects(UnloggedUser.self)[0].alexandria!.localShelves.append(newShelf)
////                        }
////                    } else {
