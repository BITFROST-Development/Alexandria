...
//        if loggedIn {
//            return realm.objects(CloudUser.self)[0].alexandria!.shelves.count + realm.objects(CloudUser.self)[0].alexandria!.localShelves.count + 2
//        } else {
//            return realm.objects(UnloggedUser.self)[0].alexandria!.localShelves.count + 2
//        }
//    }
//    
...
//            cell.controller = viewController
//            if loggedIn{
//                if indexPath.row - 2 < realm.objects(CloudUser.self)[0].alexandria!.shelves.count{
//                    cell.shelfName.text = realm.objects(CloudUser.self)[0].alexandria!.shelves[indexPath.row - 2].name!
//                    cell.cloudVar = true
//                } else {
//                    cell.shelfName.text = realm.objects(CloudUser.self)[0].alexandria!.localShelves[indexPath.row - realm.objects(CloudUser.self)[0].alexandria!.shelves.count - 2].name!
//                }
//            } else {
//                cell.shelfName.text = realm.objects(UnloggedUser.self)[0].alexandria!.localShelves[indexPath.row - 2].name!
//            }
//            return cell
//        }
//    }
...
//        } else {
//            GoogleDriveTools.retrieveBookFromDrive(id: currentBook!.driveID!, name: currentBook!.name! + ".pdf", service: GoogleDriveTools.service){ success in
//                do{
//                    try self.realm.write({
//                        self.currentBook!.localAddress = FileManager.default.urls(for: .documentDirectory, in: .userDomainMask)[0].path + "/Books/\(self.currentBook!.name!).pdf"
//                    })
...
//            presentedView.originalFileName = currentBook?.name
